...
Note that while we collaborate closely with MIT [Open Learning](https://openlearning.mit.edu/), we are a separate entity from MIT [OpenCourseWare](https://ocw.mit.edu/).
We currently operate as a student club at MIT.

If you are an educator and are open to putting your teaching materials online, we would love to help you with that process.
To see the course materials we've curated so far, look at the [courses](/courses/) tab.
